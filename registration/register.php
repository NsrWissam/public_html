<div class="col-lg-12 text-center mb-2">
    <h2 class="mt-3">Welcome to my blog!</h2>
</div>
...
<div class="col-lg-4 col-sm-8 text-center">
    ...
    <div class="row">
        <form class="mt-3 text-center" action="index.php" method="post" autocomplete="off">
            <div class="row">
                <div class="col-2">
                    <button class="form-control" type="button" disabled=""><i class="fa fa-user"></i>
                    </button>
                </div>
                <div class="col-10">
                    <input value="" class="form-control" type="text" name="first_name"
                           placeholder="Homer" id="first_name">
                </div>
                ...
                <div class="col-10">
                    <input value="" class="form-control" type="text" name="last_name"
                           placeholder="Simpsons" id="last_name">
                </div>

                <div class="col-2">
                    <button class="form-control" type="button" disabled=""><i class="fa fa-envelope"></i>
                    </button>
                </div>
                <div class="col-10">
                    <input value="" class="form-control" type="email" name="email"
                           placeholder="test@test.com" id="email">
                </div>

                <div class="col-2">
                    <button class="form-control" type="button" disabled=""><i class="fa fa-lock"></i>
                    </button>
                </div>
                <div class="col-10">
