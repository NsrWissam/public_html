        ...
        <form action="index.php" method="post" autocomplete="off" class="myForm">
            <table cellpadding="6em" class="mt-5">
                <tr class="">
                    ...
                    <td align="left"><input class="w-100" id="title" name='title' type="text" required autocomplete="off" placeholder="Your Title"/></td>
                </tr>
                <tr class="">
                ...
                <tr class="">
                    ...
                    <td align="left"><input class="w-100" name='image' id="image" type="text" required autocomplete="off"/></td>
                </tr>
                <tr class="">
                    <td class="align-text-top" style="vertical-align: top;"><label for="posttext">Post Text</label></td>
                    <td align="left"><textarea name="posttext" id="posttext" cols="40" rows="10" placeholder="Type your blog text here..."></textarea></td>
                </tr>
                <tr class="">
                    <td colspan="2"><button name="submitPost" id="submitPost" type="submit" class="button button-block">
                            Submit Blog
                        </button></td>
                </tr>
            </table>
