<nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar " style="background-color: #5a6268;">
    <div id="MainMenu" style="color: white;">


            <a href="#collapse1" class="navbar-text mb-0 mt-3 clg" data-parent="#MainMenu" data-toggle="collapse">Categories
